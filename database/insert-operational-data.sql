...
-- Auctions
(2, 'Classic sports coupe 1985, collector item, vintage condition', 250000, '2025-01-05 09:00:00', 10, 'pending', TRUE),
(3, 'Rare classic roadster 1990, exceptional condition', 180000, '2025-01-10 14:30:00', 10, 'pending', TRUE),
(4, 'Exotic sports coupe 1997, perfect mechanical condition', 320000, '2025-01-15 16:45:00', 10, 'pending', TRUE),
(5, 'Vintage coupe 1968, restored, original components', 230000, '2025-01-20 11:20:00', 10, 'pending', TRUE),
(6, 'Exotic two-door 2008, low mileage, luxury finish', 450000, '2025-01-25 15:10:00', 10, 'pending', TRUE),
(7, 'Classic British sports car 1964, collector’s edition', 550000, '2025-01-30 13:40:00', 10, 'pending', TRUE),
(8, 'Luxury grand tourer 2010, exceptional condition', 390000, '2025-02-04 10:15:00', 10, 'pending', TRUE),
(9, 'Classic American sports car 1975, iconic design', 180000, '2025-02-09 14:00:00', 10, 'pending', TRUE),
(10, 'Luxury grand tourer 2012, high-performance', 280000, '2025-02-14 12:30:00', 10, 'pending', TRUE),
(2, 'Classic off-road 2000, rugged design', 150000, '2025-01-08 09:45:00', 5, 'pending', TRUE),
(3, 'Performance coupe 2012, track-ready, modified', 190000, '2025-01-13 16:20:00', 5, 'pending', TRUE),
(4, 'Muscle coupe 2015, powerful engine', 170000, '2025-01-18 11:50:00', 5, 'pending', TRUE),
(5, 'Italian sports coupe 2016, lightweight design', 210000, '2025-01-23 14:15:00', 5, 'pending', TRUE),
(6, 'High-performance rally-inspired coupe 2014', 130000, '2025-01-28 10:30:00', 5, 'pending', TRUE),
(7, 'Lightweight sports roadster 2010, minimalistic design', 160000, '2025-02-02 15:45:00', 5, 'pending', TRUE),
(8, 'Elegant grand tourer 2013, luxury amenities', 240000, '2025-02-07 12:00:00', 5, 'pending', TRUE),
(9, 'Luxury performance sedan 2016, high output', 185000, '2025-02-12 09:20:00', 5, 'pending', TRUE),
(10, 'Rare supercar 2011, limited production', 950000, '2025-02-17 16:40:00', 10, 'pending', TRUE),
(2, 'Mid-engine sports coupe 2017, dynamic handling', 220000, '2025-01-11 13:10:00', 5, 'pending', TRUE),
(3, 'Everyday supercar 2014, road-legal performance', 380000, '2025-01-16 10:50:00', 10, 'pending', TRUE),
(4, 'High-performance sports coupe 2015, advanced engineering', 290000, '2025-01-21 15:30:00', 5, 'pending', TRUE),
(5, 'Exotic supercar 2018, cutting-edge performance', 650000, '2025-01-26 12:45:00', 10, 'pending', TRUE),
(6, 'Legendary hypercar 2008, top-tier performance', 2500000, '2025-01-31 14:55:00', 10, 'pending', TRUE);
