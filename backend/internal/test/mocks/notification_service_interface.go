...
func (_m *NotificationServiceInterface) CreateEndAuctionNotification(_a0 *models.Notification, winner string, winningBid uint, offer *models.SaleOffer) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*models.Notification, string, uint, *models.SaleOffer) error); ok {
...
func (_c *NotificationServiceInterface_CreateEndAuctionNotification_Call) Run(run func(_a0 *models.Notification, winner string, winningBid uint, offer *models.SaleOffer)) *NotificationServiceInterface_CreateEndAuctionNotification_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*models.Notification), args[1].(string), args[2].(uint), args[3].(*models.SaleOffer))
	})
	return _c
}
...
func (_c *NotificationServiceInterface_CreateEndAuctionNotification_Call) RunAndReturn(run func(*models.Notification, string, uint, *models.SaleOffer) error) *NotificationServiceInterface_CreateEndAuctionNotification_Call {
	_c.Call.Return(run)
	return _c
}

// CreateOutbidNotification provides a mock function with given fields: _a0, amount, offer
func (_m *NotificationServiceInterface) CreateOutbidNotification(_a0 *models.Notification, amount uint, offer *models.Auction) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*models.Notification, uint, *models.Auction) error); ok {
...
func (_c *NotificationServiceInterface_CreateOutbidNotification_Call) Run(run func(_a0 *models.Notification, amount uint, offer *models.Auction)) *NotificationServiceInterface_CreateOutbidNotification_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*models.Notification), args[1].(uint), args[2].(*models.Auction))
	})
	return _c
}
...
func (_c *NotificationServiceInterface_CreateOutbidNotification_Call) RunAndReturn(run func(*models.Notification, uint, *models.Auction) error) *NotificationServiceInterface_CreateOutbidNotification_Call {
	_c.Call.Return(run)
	return _c
}
