...
export function parseFiltersParams(
  ...
  return {
    ...
    price_range:
      parseIntOrUndefined(searchParams?.Price_min) ||
      parseIntOrUndefined(searchParams?.Price_max)
        ? {
        ...
        : undefined,
    mileage_range:
      parseIntOrUndefined(searchParams?.Mileage_min) ||
      parseIntOrUndefined(searchParams?.Mileage_max)
        ? {
        ...
        : undefined,
    year_range:
      parseIntOrUndefined(searchParams?.Productionyear_min) ||
      parseIntOrUndefined(searchParams?.Productionyear_max)
        ? {
        ...
        : undefined,
    engine_capacity_range:
      parseIntOrUndefined(searchParams?.Enginecapacity_min) ||
      parseIntOrUndefined(searchParams?.Enginecapacity_max)
        ? {
        ...
        : undefined,
    engine_power_range:
      parseIntOrUndefined(searchParams?.Enginepower_min) ||
      parseIntOrUndefined(searchParams?.Enginepower_max)
        ? {
