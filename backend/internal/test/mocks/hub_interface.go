...
import (
	...
	ws "github.com/susek555/BD2/car-dealer-api/internal/domains/ws"
)
...
// SendFourLatestNotificationsToClient provides a mock function with given fields: client
func (_m *HubInterface) SendFourLatestNotificationsToClient(client *ws.Client) {
	_m.Called(client)
}
...
//   - client *ws.Client
func (_e *HubInterface_Expecter) SendFourLatestNotificationsToClient(client interface{}) *HubInterface_SendFourLatestNotificationsToClient_Call {
	return &HubInterface_SendFourLatestNotificationsToClient_Call{Call: _e.mock.On("SendFourLatestNotificationsToClient", client)}
}

func (_c *HubInterface_SendFourLatestNotificationsToClient_Call) Run(run func(client *ws.Client)) *HubInterface_SendFourLatestNotificationsToClient_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *HubInterface_SendFourLatestNotificationsToClient_Call) RunAndReturn(run func(*ws.Client)) *HubInterface_SendFourLatestNotificationsToClient_Call {
	_c.Run(run)
	return _c
}

// SendFourLatestNotificationsToClients provides a mock function with given fields: offerID, userID
func (_m *HubInterface) SendFourLatestNotificationsToClients(offerID string, userID string) {
	_m.Called(offerID, userID)
}

// HubInterface_SendFourLatestNotificationsToClients_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SendFourLatestNotificationsToClients'
type HubInterface_SendFourLatestNotificationsToClients_Call struct {
	*mock.Call
}

// SendFourLatestNotificationsToClients is a helper method to define mock.On call
//   - offerID string
//   - userID string
func (_e *HubInterface_Expecter) SendFourLatestNotificationsToClients(offerID interface{}, userID interface{}) *HubInterface_SendFourLatestNotificationsToClients_Call {
	return &HubInterface_SendFourLatestNotificationsToClients_Call{Call: _e.mock.On("SendFourLatestNotificationsToClients", offerID, userID)}
}

func (_c *HubInterface_SendFourLatestNotificationsToClients_Call) Run(run func(offerID string, userID string)) *HubInterface_SendFourLatestNotificationsToClients_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *HubInterface_SendFourLatestNotificationsToClients_Call) Return() *HubInterface_SendFourLatestNotificationsToClients_Call {
	_c.Call.Return()
	return _c
}

func (_c *HubInterface_SendFourLatestNotificationsToClients_Call) RunAndReturn(run func(string, string)) *HubInterface_SendFourLatestNotificationsToClients_Call {
	_c.Run(run)
	return _c
}
...
// UnsubscribeUser provides a mock function with given fields: userID, offerID
func (_m *HubInterface) UnsubscribeUser(userID string, offerID string) {
	_m.Called(userID, offerID)
}

// HubInterface_UnsubscribeUser_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UnsubscribeUser'
type HubInterface_UnsubscribeUser_Call struct {
	*mock.Call
}

// UnsubscribeUser is a helper method to define mock.On call
//   - userID string
//   - offerID string
func (_e *HubInterface_Expecter) UnsubscribeUser(userID interface{}, offerID interface{}) *HubInterface_UnsubscribeUser_Call {
	return &HubInterface_UnsubscribeUser_Call{Call: _e.mock.On("UnsubscribeUser", userID, offerID)}
}

func (_c *HubInterface_UnsubscribeUser_Call) Run(run func(userID string, offerID string)) *HubInterface_UnsubscribeUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string))
	})
	return _c
...
func (_c *HubInterface_UnsubscribeUser_Call) Return() *HubInterface_UnsubscribeUser_Call {
	_c.Call.Return()
	return _c
}

func (_c *HubInterface_UnsubscribeUser_Call) RunAndReturn(run func(string, string)) *HubInterface_UnsubscribeUser_Call {
	_c.Run(run)
	return _c
}
